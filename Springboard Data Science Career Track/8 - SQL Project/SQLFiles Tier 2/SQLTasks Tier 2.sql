...
SELECT name,
    ...
    CASE WHEN monthlymaintenance < 100 THEN 'cheap'
        ELSE 'expensive' END AS Expense_Category
FROM Facilities
...
SELECT f.name AS Facility_name,
    CONCAT(firstname,' ',surname) as Booker_name,
    CASE WHEN b.memid = 0 THEN f.guestcost
        WHEN b.memid !=0 THEN f.membercost END AS Cost,
    b.bookid
FROM Bookings AS b
INNER JOIN Facilities As f
ON b.facid = f.facid
...
See Jupyter Notebook named 'SQL Project - Questions 10-13'
